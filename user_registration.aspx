<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="user_registration.aspx.cs" Inherits="Default2" %>
    ...
    <table style="width: 100%; margin-left: 50px;">
        ...
        <tr>
            ...
            <td class="auto-style23">
                <asp:Button ID="Button1" runat="server" Height="27px" Text="Register" Width="126px" OnClick="Button1_Click1" />
